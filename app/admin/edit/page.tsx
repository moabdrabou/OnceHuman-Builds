...
import { ShieldAlert, Save, Activity, Shield, Sword, Crosshair, Sparkles, Loader2, ArrowLeft, RefreshCcw } from "lucide-react"
...
export default function AdminEditPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Delete and Replace strategy for relational tables
      await Promise.all([
      ...
      // 3. Prepare & Insert new relational data
      const gearInserts = [
        ...
        { build_id: selectedBuildId, slot_name: "weapon_1", weapon_id: weapon1.id || null, mod_id: weapon1.modId || null },
        { build_id: selectedBuildId, slot_name: "weapon_2", weapon_id: weapon2.id || null, mod_id: weapon2.modId || null },
        { build_id: selectedBuildId, slot_name: "melee", weapon_id: melee.id || null, mod_id: melee.modId || null }
      ]
